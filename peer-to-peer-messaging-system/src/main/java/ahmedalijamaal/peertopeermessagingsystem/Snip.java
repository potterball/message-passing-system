...
public class Snip implements Comparable<Snip> {
   ...
   */
  public Snip(int lamport_timestamp, String content, String timestamp, ProcessAddress source) {
  ...
  public String toString() {
    return lamport_timestamp + " " + this.content + " " + source.toString();
  }
   ...
   * @return 0 if the logical timestamps are equal, 1 if snip being compared to
   *         has smaller timestamp else -1
   */
